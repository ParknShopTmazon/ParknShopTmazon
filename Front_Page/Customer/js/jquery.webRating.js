            ...
            items.each(function() {
                ...
                for (var i = 0; i < configuration.ratingCount; i++) {
                    ...
                    starImg.style.clip = "rect(" + configuration.yLocation + "px," +
                        (+configuration.xLocation + +configuration.width) + "px," + (+configuration.yLocation + +configuration.height) + "px," + configuration.xLocation + "px)";
                ...
                $(starContainer).on({
                    ...
                    click: function() {
                        ...
                        //     offDiv.style.width = _getOffPercentage(score);
                        // }
                        $bgDiv.data("score", clickScore);
                        onDiv.style.width = _getOnPercentage(clickScore);
                        offDiv.style.width = _getOffPercentage(clickScore);
