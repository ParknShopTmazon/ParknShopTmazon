			...
			<form class="complete-info">
				...
				<div class="item-uphoto form-item">
					...
					<div class="uphoto-control form-control">
						...
						<br>
						<input type="button" value="change_picture" height="30px" sytle="font-size:1000px;">
					</div>
				</div>		 
				<div class="form-item">
				...
				<div class="form-item">
					...
					<div class="form-control">
						...
						<input type="button" value="Delete Product" height="30px" sytle="font-size:1000px;">
					</div>
				</div>			
			</form>
	   </div>
